package
{
   ...
   public final class CanvasDiscoveryConsumerAUpdate extends MovieClip
   {
      private var marker:TextField;

      public function CanvasDiscoveryConsumerAUpdate()
      {
         this.marker = this.createMarker("VWCANVAS-9 CONSUMER A2 UPDATE",16744448);
      }
