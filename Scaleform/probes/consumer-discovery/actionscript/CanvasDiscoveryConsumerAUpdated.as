package
{
   ...
   public final class CanvasDiscoveryConsumerAUpdated extends MovieClip
   {
      private var marker:TextField;

      public function CanvasDiscoveryConsumerAUpdated()
      {
         this.marker = this.createMarker("VWCANVAS-9 CONSUMER A UPDATED",16744448);
      }
